...
oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Нет данных",sInfo:"Показано от _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показано от 0 до 0 из 0 записей",sInfoFiltered:"(отфильтровано _MAX_ общих записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"В процессе...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не найдено соответствующих записей"},oSearch:h.extend({},
